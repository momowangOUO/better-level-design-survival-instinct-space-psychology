...
>
> 这篇改写从 Totten 的生存本能文章出发，把展望、庇护、尺度、阴影、材质和高度翻译成关卡审核问题：哪里让人敢走，哪里让人退缩，哪里让人想冒险。
>
...
- 关卡空间会先碰到玩家的生存直觉：视野、庇护、尺度、材质、阴影和高度都会改变安全感与行动欲望。
- “主角弱势问题”不只靠数值补偿解决，空间也能给玩家可见出口、回撤点和逐步掌控的机会。
- 展望与庇护必须成对出现；只给开阔视野会让玩家暴露，只给安全角落又会抽掉行动张力。
...
优秀关卡不只是好看的空间，也不只是敌人、道具和门的摆放组合。它要让玩家进入一个危险但能读懂的环境：先看见风险，再寻找庇护，判断路线，克服障碍，最后获得安全抵达、击败强敌或拿到奖励的满足。
